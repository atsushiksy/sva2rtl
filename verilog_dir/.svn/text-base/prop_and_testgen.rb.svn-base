...
def gen_test1
# case of ( exp0 |-> exp1 ##1 exp2 ) and ( exp3 |-> exp4 ##1 exp5 )
  ...
  set_trigger( $nov+$nov+2, "exp4" ) 
  set_trigger( $nov+$nov+3, "exp2" ) 
  set_trigger( $nov+$nov+3, "exp5" ) 
  if( $nov == 1 ) 
    set_check( $nov+$nov+4, "err || mtch || !ovwp" ) 
  end
...
def gen_test2
# case of ( ( exp0 ##1 exp1 |-> exp2 ##1 exp3 ) AND ( exp4 ##1 exp5 |-> exp6 ##1 exp7 ) )
  ...
  set_trigger( 1, "exp5" ) 
  set_trigger( $nov+1, "exp2" ) 
  set_trigger( $nov+1, "exp6" ) 
  set_trigger( $nov+2, "exp3" ) 
  set_trigger( $nov+2, "exp7" ) 
  if( $nov == 1 ) 
    set_check( $nov+2, "err || mtch || !ovwp" ) 
  end
  set_check( $nov+3, "err || mtch || !ovwp" ) 
  ...
  set_trigger( $nov+3, "exp4" ) 
  set_trigger( $nov+4, "exp1" ) 
  set_trigger( $nov+4, "exp5" ) 
  set_trigger( $nov+$nov+4, "exp2" ) 
  set_trigger( $nov+$nov+4, "exp6" ) 
  set_trigger( $nov+$nov+5, "exp3" ) 
  set_trigger( $nov+$nov+5, "exp7" ) 
  if( $nov == 1 ) 
    set_check( $nov+$nov+5, "err || mtch || !ovwp" ) 
  end
  set_check( $nov+$nov+6, "err || mtch || !ovwp" ) 
  ...
  set_trigger( 1, "exp1" ) 
  set_trigger( 1, "exp5" ) 
  set_trigger( $nov+0, "exp2" ) 
  set_trigger( $nov+0, "exp6" ) 
  set_trigger( $nov+1, "exp3" ) 
  set_trigger( $nov+1, "exp7" ) 
  if( $nov == 1 ) 
    set_check( $nov+2, "err || mtch || !ovwp" ) 
  end
  set_check( $nov+3, "err || mtch || !ovwp" ) 
...
$test = sprintf( "( ( exp0 |-> exp1 ##1 exp2 ) and ( exp3 |-> exp4 ##1 exp5 ) )" )
$nov = 0 
gen_test1
fname = sprintf(  "prop_p_exp_2_exp_D1_exp_p_AND_p_exp_2_exp_D1_exp_p"  )
gen_test_file( fname )
...
$nov = 1
gen_test1
fname = sprintf(  "prop_p_exp_3_exp_D1_exp_p_AND_p_exp_3_exp_D1_exp_p"  )
gen_test_file( fname )
...
$test = sprintf( "( ( exp0 ##1 exp1 |-> exp2 ##1 exp3 ) and ( exp4 ##1 exp5 |-> exp6 ##1 exp7 ) )" )
$nov = 0 
gen_test2
fname = sprintf(  "prop_p_exp_D1_exp_2_exp_D1_exp_p_AND_p_exp_D1_exp_2_exp_D1_exp_p"  )
gen_test_file( fname )

$test = sprintf( "( ( exp0 ##1 exp1 |=> exp2 ##1 exp3 ) and ( exp4 ##1 exp5 |=> exp6 ##1 exp7 ) )" )
$nov = 1 
gen_test2
fname = sprintf(  "prop_p_exp_D1_exp_3_exp_D1_exp_p_AND_p_exp_D1_exp_3_exp_D1_exp_p"  )
gen_test_file( fname )
