...
# case of not( exp0 |-> exp1 ##1 exp2 )
  ...
  set_trigger( 0, "exp1", 2 ) 
  set_trigger( 1, "exp2" ) 
  set_check( 1, "!err || mtch || ovwp" ) 
  set_check( 2, "!err || mtch || ovwp" ) 
  set_check( 3, "!err || mtch || ovwp" ) 
  set_check( 4, "err || !mtch || ovwp" ) 
...
$test = sprintf( "exp0 ##1 exp1" )
$nov = 0 
gen_test1
fname = sprintf(  "prop_exp_D1_exp"  )
gen_test_file( fname )

$test = sprintf( "not( exp0 ##1 exp1 )" )
$nov = 0 
gen_test2
fname = sprintf(  "prop_not_p_exp_D1_exp_p"  )
gen_test_file( fname )

$test = sprintf( "not( exp0 |-> exp1 ##1 exp2 )" )
$nov = 0 
gen_test3
fname = sprintf(  "prop_not_p_exp_2_exp_D1_exp_p"  )
gen_test_file( fname )

##$test = sprintf( "( ( exp0 |-> exp1 ##1 exp2 ) or ( exp3 |-> exp4 ##1 exp5 ) )" )
##$nov = 0 
##gen_test4
##fname = sprintf(  "prop_p_exp_2_exp_D1_exp_p_OR_p_exp_2_exp_D1_exp_p"  )
##gen_test_file( fname )
