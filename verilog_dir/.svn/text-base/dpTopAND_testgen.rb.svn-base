...
def gen_test1( d0, d1 )
# case of "exp0 |-> (  ( exp1 ##[1:%d] exp2 ) and ( exp1 ##[1:%d] exp3 ) ) ##1 exp4"
  ...
  1.upto(d0) do |t0| 
    1.upto(d1) do |t1|
      ...
      set_trigger( $nov+t1, "exp3" ) 
      set_trigger( $nov+t3+1, "exp4" ) 
      set_check( $nov+t3+3, "err || !mtch || ovwp" ) 
...
$test = sprintf( "exp0 |-> (  ( exp1 ##[1:%d] exp2 ) and ( exp1 ##[1:%d] exp3 ) ) ##1 exp4", d0, d1 )
$nov = 0 
gen_test1( d0, d1 )
fname = sprintf(  "dp_exp_2_p_seq%d_AND_seq%d_p_D_exp", d0, d1 )
gen_test_file( fname )
$test = sprintf( "exp0 |=> (  ( exp1 ##[1:%d] exp2 ) and ( exp1 ##[1:%d] exp3 ) ) ##1 exp4", d0, d1 )
$nov = 1
gen_test1( d0, d1 )
fname = sprintf(  "dp_exp_3_p_seq%d_AND_seq%d_p_D_exp", d0, d1 )
gen_test_file( fname )
