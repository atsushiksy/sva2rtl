...
# case of exp0 ##d0 exp1 |-> exp2 ##d1 exp3
  ...
  set_trigger( 0, "exp0" ) 
  set_trigger( d0, "exp1"  )        
  set_trigger( d0+$nov, "exp2"  )        
  set_trigger( d0+d1+$nov, "exp3" )
...
$test =  "exp0 ##d0 exp1 |-> exp2 ##d1 exp3 "
$nov = 0 
gen_test1( d0, d1 )
fname = sprintf(  "arg_exp_D_exp_2_exp_D_exp_%d_%d", d0, d1 )
gen_test_file( fname )
$test =  "exp0 ##d0 exp1 |=> exp2 ##d1 exp3 "
$nov = 1
gen_test1( d0, d1 )
fname = sprintf(  "arg_exp_D_exp_3_exp_D_exp_%d_%d", d0, d1 )
gen_test_file( fname )
