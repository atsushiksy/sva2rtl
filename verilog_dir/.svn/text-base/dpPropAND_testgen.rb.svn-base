...
$nov = 0 
gen_test1
fname = sprintf(  "DPprop_p_exp_2_exp_D1_exp_p_AND_p_exp_2_exp_D1_exp_p"  )
gen_test_file( fname )
...
$nov = 1
gen_test1
fname = sprintf(  "DPprop_p_exp_3_exp_D1_exp_p_AND_p_exp_3_exp_D1_exp_p"  )
gen_test_file( fname )
...
$nov = 0 
gen_test2
fname = sprintf(  "DPprop_p_exp_D1_exp_2_exp_D1_exp_p_AND_p_exp_D1_exp_2_exp_D1_exp_p"  )
gen_test_file( fname )

$test = sprintf( "( ( exp0 ##1 exp1 |=> exp2 ##1 exp3 ) and ( exp4 ##1 exp5 |=> exp6 ##1 exp7 ) )" )
$nov = 1 
gen_test2
fname = sprintf(  "DPprop_p_exp_D1_exp_3_exp_D1_exp_p_AND_p_exp_D1_exp_3_exp_D1_exp_p"  )
gen_test_file( fname )
