...
$actarg_code = ""
$test =  "exp0 |-> ( exp1 ##[1:5] exp2 ) and ( exp3 ##[1:5] exp4 ) "
$nov = 0 
gen_test1
fname = sprintf(  "exp_2_p_exp_D1_5_exp_p_PAND_p_exp_D1_5_exp_p" )
gen_test_file( fname )
$test =  "exp0 |=> ( exp1 ##[1:5] exp2 ) and ( exp3 ##[1:5] exp4 ) "
$nov = 1
gen_test1
fname = sprintf(  "exp_3_p_exp_D1_5_exp_p_PAND_p_exp_D1_5_exp_p" )
gen_test_file( fname )
