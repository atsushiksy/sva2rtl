...
$test =  "exp0 ##d0 (exp1, data = exp2) |-> exp3 ##d1 ( exp4 == data ) ##1 ( exp2 == data ) "
$nov = 0 
gen_test1( d0, d1 )
fname = sprintf(  "lvrbb_exp_D_expS_2_exp_D_expR_D_expR_%d_%d", d0, d1 )
gen_test_file( fname )
...
$nov = 1
gen_test1( d0, d1 )
fname = sprintf(  "lvrbb_exp_D_expS_3_exp_D_expR_D_expR_%d_%d", d0, d1 )
gen_test_file( fname )
