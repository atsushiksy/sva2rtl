...
$nov = 1
gen_test1
fname = sprintf(  "prop_p_exp_3_exp_D1_exp_p_OR_p_exp_3_exp_D1_exp_p"  )
gen_test_file( fname )
...
$nov = 0 
gen_test2
fname = sprintf(  "prop_p_exp_D1_exp_2_exp_D1_exp_p_OR_p_exp_D1_exp_2_exp_D1_exp_p"  )
gen_test_file( fname )

$test = sprintf( "( ( exp0 ##1 exp1 |=> exp2 ##1 exp3 ) or ( exp4 ##1 exp5 |=> exp6 ##1 exp7 ) )" )
$nov = 1 
gen_test2
fname = sprintf(  "prop_p_exp_D1_exp_3_exp_D1_exp_p_OR_p_exp_D1_exp_3_exp_D1_exp_p"  )
gen_test_file( fname )
